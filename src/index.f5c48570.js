...
})({"hNkkC":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = 1234;
...
const updateUIForWordOfTheDay = async (wordOfTheDay)=>{
    ...
    _util.$(WORD_DATE_ID).innerText = isArchived ? wordOfTheDay.date : ARCHIVED;
    _util.$(WORD_MAIN_ID).innerText = wordOfTheDay.word;
    _util.$(WORD_ATTRIBUTE_ID).innerText = wordOfTheDay.attribute;
    _util.$(WORD_SYLLABLES_ID).innerText = wordOfTheDay.syllables;
    _util.$(WORD_MEANING_ID).innerHTML = wordOfTheDay.meaning;
    _util.$(WORD_EXAMPLE_ID).innerHTML = wordOfTheDay.example;
};
async function onWindowLoad() {
    const wordOfTheDay = await _wordy.getMostRecentWordOfTheDay();
...
},{"./wordy":"hQgQj","./util":"cgcsT"}],"hQgQj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getMostRecentWordOfTheDay", ()=>getMostRecentWordOfTheDay
);
...
const WORD_OF_THE_DAY_QUERY = {
    ...
    example: 'div.wod-article-container div.wod-definition-container div.wotd-examples div.left-content-box p'
};
const getWordOfTheDayOverInternet = async ()=>{
    ...
    let domFromResponse = new DOMParser().parseFromString(responseText, 'text/html');
...
const getMostRecentWordOfTheDay = async ()=>{
    const recentWordOfTheDay = await _storageDefault.default.getRecentWordOfTheDay();
    const todaysDate = new Date().toDateString();
    if (recentWordOfTheDay.date === todaysDate) return recentWordOfTheDay;
    try {
        const wordOfTheDay = await getWordOfTheDayOverInternet();
        _storageDefault.default.setRecentWordOfTheDay(wordOfTheDay);
        return wordOfTheDay;
    } catch  {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./storage":"bkDau"}],"gkKU3":[function(require,module,exports) {
...
const isChromeStorageAvailable = window.chrome !== undefined && window.chrome.storage !== undefined;
// Chrome may not be available on host.
// Fallback to noop storage if chrome is not available.
const chromeStorage = isChromeStorageAvailable ? window.chrome.storage.local : {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cgcsT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hNkkC","8ZNvh"], "8ZNvh", "parcelRequirecd19")
